(function(f) {
    f.fn.twittie = function(e, l) {
        var p = "function" === typeof e ? e : l,
            c = f.extend({ username: 'PostOnce', list: null, hashtag: null, count: 10, hideReplies: !1, dateFormat: "%b/%d/%Y", template: "{{date}} - {{tweet}}", apiPath: "api/tweet.php" }, e instanceof Object ? e : {});
        ...
        var m = function(c) {
            ...
            q = function(g) { for (var d = c.template, a = "date tweet avatar url retweeted screen_name user_name".split(" "), h = 0, b = a.length; h < b; h++) d = d.replace(new RegExp("{{" + a[h] + "}}", "gi"), g[a[h]]); return d };
        ...
        f.getJSON(c.apiPath, {
            ...
            n.find("span").fadeOut("fast", function() {
                ...
                for (var d = 0; d < c.count; d++) {
                    ...
                    a = { user_name: h, date: k, tweet: a.retweeted ? m("RT @" + a.user.screen_name + ": " + a.retweeted_status.text) : m(a.text), avatar: '<img src="' + a.user.profile_image_url + '" />', url: "http://twitter.com/" + a.user.screen_name + "/status/" + a.id_str, retweeted: a.retweeted, screen_name: m("@" + a.user.screen_name) };
